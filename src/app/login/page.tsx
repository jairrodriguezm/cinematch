  ...
  return (
    <section className="w-full rounded-3xl border border-neutral-200 bg-white p-6 shadow-[0_12px_40px_rgba(15,15,16,0.06)] text-black">
      ...
      <form noValidate onSubmit={handleMagicLink} className="mt-6 space-y-3">
        <label htmlFor="email" className="block text-sm font-medium text-[#0F0F10]">
          Correo electrónico
          <input
            id="email"
            type="email"
        ...
        <button type="submit" disabled={pending !== null} className="flex w-full items-center justify-center gap-2 rounded-xl bg-[#f5c518] px-4 py-3 text-sm font-extrabold text-black transition hover:bg-amber-400 disabled:cursor-not-allowed disabled:opacity-60 shadow-md">
